...
const ADMIN_PASSWORD = process.env.ADMIN_PASSWORD || '@dmin#2025';
const STAFF_PASSWORD = process.env.STAFF_PASSWORD || '@dmin#2025';
const VOLUNTEER_PASSWORD = process.env.VOLUNTEER_PASSWORD || '@dmin#2025';
